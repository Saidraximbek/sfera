...
const AddStudent = () => {
  ...
  return (
    <form
      ...
      className="max-w-[500px] w-full mx-auto p-10 bg-amber-50 text-black shadow-2xl rounded-lg border border-gray-300 text-2xl flex flex-col gap-10"
    >
      ...
      <div className="mb-4">
        <input
          ...
          className="w-full  border-gray-300 p-3 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-900 focus:scale-105 transition"
          required
        />
      </div>
